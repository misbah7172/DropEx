        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            searchInput.addEventListener('input', function() {
                ...
                branchCards.forEach(card => {
                    ...
                    const contact = card.querySelector('.branch-contact').textContent.toLowerCase();
                    const email = card.querySelector('.branch-email').textContent.toLowerCase();
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
            ...
            <div class="max-w-md mx-auto mb-8">
                <input 
                    type="text" 
                    id="branch-search" 
                    placeholder="Search branches by address, contact, or email" 
            ...
            <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                <?php foreach($branches as $branch) : ?>
                    <div class="branch-card bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 p-6">
                        <ul class="space-y-4">
                            <li class="flex items-center text-gray-700">
                                <i class="fa fa-map-marker text-blue-600 text-xl w-8"></i>
                                <span class="ml-2 branch-address"><?php echo htmlspecialchars($branch['Address']); ?></span>
                            </li>
                            <li class="flex items-center text-gray-700">
                                <i class="fa fa-phone text-blue-600 text-xl w-8"></i>
                                <span class="ml-2 branch-contact"><?php echo htmlspecialchars($branch['Contact']); ?></span>
                            </li>
                            <li class="flex items-center text-gray-700">
                                <i class="fa fa-envelope text-blue-600 text-xl w-8"></i>
                                <span class="ml-2 branch-email"><?php echo htmlspecialchars($branch['Email']); ?></span>
                            </li>
                        </ul>
                    </div>
                <?php endforeach; ?>
